...
namespace spark {
    namespace scene {
        ...
        *
        */
        spark::game::ISparkSprite* SceneGraphManager2D::createSprite(spark::drawing::ISparkImage* image)
        {
        ...
        *
        */
        spark::game::ISparkLineLayer* SceneGraphManager2D::createLineLayer(int16_t x1, int16_t y1, int16_t x2, int16_t y2, spark::drawing::Color color)
        {
