...
namespace spark {
    namespace renderer {
        ...
        *
        */
        Vulkan13Renderer::Vulkan13Renderer(spark::device::ISparkDevice* device, spark::renderer::shader::ISparkShader* shader, spark::device::window::ISparkWindow* window) :
        ...
        *
        */
        void Vulkan13Renderer::findPhysicalDevices()
        {
        ...
        *
        */
        void Vulkan13Renderer::createCommandBuffer()
        {
        ...
        *
        */
        void Vulkan13Renderer::isSwapChainSupportAvailable()
        {
        ...
        *
        */
        void Vulkan13Renderer::createSwapChain()
        {
        ...
        *
        */
        void Vulkan13Renderer::createRenderPass()
        {
