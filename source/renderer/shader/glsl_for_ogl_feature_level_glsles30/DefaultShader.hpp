...
// </auto-generated>
//------------------------------------------------------------------------------
#ifndef __SPARK_RENDERER_SHADER_GLSL_FOR_OGL_FEATURE_LEVEL_GLSLES30_DEFAULTSHADER_HPP_INCLUDED__
#define __SPARK_RENDERER_SHADER_GLSL_FOR_OGL_FEATURE_LEVEL_GLSLES30_DEFAULTSHADER_HPP_INCLUDED__

namespace spark {
	namespace renderer {
		namespace shader {
			namespace glsl_for_ogl_feature_level_glsles30 {
				/// <summary>
				///
				/// <summary>
				class DefaultShader
