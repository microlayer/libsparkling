...
namespace spark::geometry::mesh::generator {
    ...
    * Left:  (-cos, sin, 0)
    */
    spark::geometry::mesh::ISparkMesh* MeshGenerator::createPyramidMesh()
    {
        real32 cos = 0.89f;
        real32 sin = 0.45f;

        spark::geometry::mesh::Mesh* m = new spark::geometry::mesh::Mesh();
    ...
    *  v2------v3
    */
    spark::geometry::mesh::ISparkMesh* MeshGenerator::createQuadMesh()
    {
        spark::geometry::mesh::Mesh* m = new spark::geometry::mesh::Mesh();
    ...
    */
    spark::geometry::mesh::ISparkMesh* MeshGenerator::createPlaneMesh()
    {
        spark::geometry::mesh::Mesh* m = new spark::geometry::mesh::Mesh();
    ...
    */
    spark::geometry::mesh::ISparkMesh* MeshGenerator::createSphereMesh(uint32_t recursionLevel)
    {
        return NULL;
    }
}